/*
Code from:
https://www.digitalocean.com/community/tutorials/how-to-use-go-with-mongodb-using-the-mongodb-go-driver-es
*/
...
func init() {
	...
	collection = client.Database("tasker").Collection("tasks") //Crea la base de datos
}
